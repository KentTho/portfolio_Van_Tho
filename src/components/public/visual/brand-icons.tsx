/**
 * Brand marks — GitHub / LinkedIn as local inline SVGs.
 *
 * lucide-react removed its brand glyphs (trademark policy), so these are provided
 * locally for the social rail. `currentColor` fill so they inherit link color;
 * decorative (aria-hidden) — the surrounding anchor carries the accessible label.
 */

...
| **V2 Public visual enhancement** | per-section visual enhancement of the 6 blocks (Hero/About/Projects/Career/Skills/Contact) on live data | 🚧 **IN PROGRESS — Hero+Header done** (branch `feat/v2-hero-menu-enhancement`, PR open, **not merged** — Owner Visual Acceptance gate). About…Contact pending. | UI authority `PUBLIC_LANDING_DESIGN_MAP.md`; reference `docs/image_demo_portfolio/hero-section.png` + `HEROAUDIT.md` |

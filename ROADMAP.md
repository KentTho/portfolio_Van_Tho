...
| **V2 Public visual enhancement** | per-section visual enhancement of the 6 blocks (Hero/About/Projects/Career/Skills/Contact) on live data | 🚧 **IN PROGRESS — Hero+Menu+About done** (branch `feat/v2-hero-menu-enhancement`, PR #9, **not merged** — Owner Visual Acceptance gate). Projects/Career/Skills/Contact pending. | UI authority `PUBLIC_LANDING_DESIGN_MAP.md`; references `docs/image_demo_portfolio/{hero-section,About}.png` + `HEROAUDIT`/`Menu_audit`/`ABOUT01audit` |

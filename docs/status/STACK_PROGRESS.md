...
| **V2_PUBLIC_VISUAL_ENHANCEMENT** | 🚧 **IN PROGRESS — Hero+Header** | branch `feat/v2-hero-menu-enhancement`: `#home` Hero rebuilt (reference-inspired 3-zone + social rail + visible entrance), Header underline grammar; validation GREEN, e2e:public 7/7, 0 hydration errors. **Not merged** (Owner Visual Acceptance). Other sections untouched. | About/Projects/Career/Skills/Contact V2 passes pending; Owner acceptance | `V2-ABOUT-01` after acceptance |
